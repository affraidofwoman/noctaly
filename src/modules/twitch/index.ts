  ...
  champs: [
    {
      ...
      get: (c) => c.twitch.salonDefautId,
      set: (c, v) => void (c.twitch.salonDefautId = v),
    },
    { kind: 'role', cle: 'role', libelle: 'Rôle mentionné par défaut', get: (c) => c.twitch.roleDefautId, set: (c, v) => void (c.twitch.roleDefautId = v) },
    { kind: 'text', cle: 'live', libelle: 'Message de live', long: true, maxLength: 1500, required: true, get: (c) => c.twitch.messageLive, set: (c, v) => void (c.twitch.messageLive = v) },
    { kind: 'text', cle: 'end', libelle: 'Message de fin (vide = aucun)', long: true, maxLength: 1500, get: (c) => c.twitch.messageFin, set: (c, v) => void (c.twitch.messageFin = v) },
    {
      kind: 'text',
      cle: 'color',
      libelle: 'Couleur (#hex)',
      ...
      set: (c, v) => void (c.twitch.color = enHexa(lireCouleur(v) ?? 0x9146ff)),
