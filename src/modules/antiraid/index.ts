...
const pageReglage: PageReglage = {
  ...
  champs: [
    { kind: 'channel', cle: 'alert', libelle: 'Salon d’alerte (en plus de securite-log)', get: (c) => c.antiraid.salonAlerteId, set: (c, v) => void (c.antiraid.salonAlerteId = v) },
    {
      kind: 'choice',
      cle: 'suspicious',
      ...
      get: (c) => c.antiraid.actionSuspects,
      set: (c, v) => void (c.antiraid.actionSuspects = v as 'none' | 'timeout' | 'kick'),
    },
    { kind: 'toggle', cle: 'lock', libelle: 'Lockdown automatique', get: (c) => c.antiraid.verrouillageAuto, set: (c, v) => void (c.antiraid.verrouillageAuto = v) },
    { kind: 'number', cle: 'threshold', libelle: 'Arrivées déclenchant l’alerte', min: 3, max: 500, get: (c) => c.antiraid.seuilArrivees, set: (c, v) => void (c.antiraid.seuilArrivees = v) },
    { kind: 'number', cle: 'window', libelle: 'Fenêtre', min: 5, max: 3600, unit: 's', get: (c) => c.antiraid.fenetreArriveesSecondes, set: (c, v) => void (c.antiraid.fenetreArriveesSecondes = v) },
    { kind: 'number', cle: 'age', libelle: 'Compte suspect si moins de', min: 0, max: 365, unit: 'j', get: (c) => c.antiraid.ageCompteMinJours, set: (c, v) => void (c.antiraid.ageCompteMinJours = v) },
    { kind: 'number', cle: 'mentions', libelle: 'Mentions max en 30 s', min: 5, max: 500, get: (c) => c.antiraid.seuilMentions, set: (c, v) => void (c.antiraid.seuilMentions = v) },
  ],
};
