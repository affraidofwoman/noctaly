...
export const WHITELISTS: DefinitionWhitelist[] = [
  ...
  },
  {
    ...
    emoji: '🛡️',
    groupe: 'Équipe',
    description: 'Sanctionner, blacklister, fermer les salons (au-dessus du Staff)',
    portee: 'guild',
  ...
  },
  {
    ...
    emoji: '⭐',
    groupe: 'Équipe',
    description: 'Tickets, suggestions, événements et annonces (sans sanctions)',
    portee: 'guild',
  ...
  },
  {
    ...
    emoji: '🎫',
    groupe: 'Équipe',
    description: 'Voir et répondre aux tickets, rien d’autre',
    portee: 'guild',
