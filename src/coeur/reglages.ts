...
export const THEMES: Record<Exclude<ThemeId, 'custom'>, { label: string; emoji: string; colors: CouleursTheme }> = {
  discord: {
    label: 'Discord',
    emoji: '💙',
    colors: { principale: '#5865F2', succes: '#57F287', erreur: '#ED4245', attention: '#FEE75C', info: '#5865F2' },
  },
  twitch: {
    label: 'Twitch',
    emoji: '💜',
    colors: { principale: '#9146FF', succes: '#00F593', erreur: '#EB0400', attention: '#FFCA5F', info: '#BF94FF' },
  },
  gaming: {
    label: 'Gaming',
    emoji: '🎮',
    colors: { principale: '#FF4655', succes: '#3BD16F', erreur: '#FF1F3D', attention: '#FFB800', info: '#00B2FF' },
  },
  dark: {
    label: 'Dark',
    emoji: '🌑',
    colors: { principale: '#2B2D31', succes: '#248046', erreur: '#A12D2F', attention: '#B5891B', info: '#4E5058' },
  },
  neon: {
    label: 'Neon',
    emoji: '🌈',
    colors: { principale: '#00FFF7', succes: '#39FF14', erreur: '#FF073A', attention: '#FFF01F', info: '#BC13FE' },
  },
  minimal: {
    label: 'Minimal',
    emoji: '⚪',
    colors: { principale: '#E3E5E8', succes: '#A3D9A5', erreur: '#E8A3A3', attention: '#E8D9A3', info: '#A3BFE8' },
  },
};
...
export function configParDefaut(): ConfigServeur {
  return {
    ...
    reglement: {
      ...
      titre: '📜 Le règlement',
      sections: [
        { titre: '🤝 Le respect avant tout', contenu: 'Pas d’insultes, de harcèlement, de discrimination ni de drama. On parle aux autres comme on aimerait qu’on nous parle.' },
        { titre: '💬 Chaque salon a son sujet', contenu: 'Lis la description d’un salon avant d’y écrire. Pas de spam, de flood, ni de messages tout en majuscules.' },
        { titre: '🔴 Pendant les lives', contenu: 'Pas de spoil, pas de conseils que personne n’a demandés, et les embrouilles du chat restent sur Twitch.' },
        { titre: '🔗 Pub et liens', contenu: 'Aucune pub sans l’accord du staff, ici comme en message privé. Les liens douteux sont supprimés.' },
        { titre: '🔞 Contenu', contenu: 'Rien de choquant, de NSFW, d’illégal ou de piraté. Des plus jeunes nous lisent.' },
        { titre: '🔐 Vie privée', contenu: 'On ne partage aucune information personnelle, ni la sienne ni celle des autres.' },
        { titre: '🛡️ Le staff', contenu: 'Ses décisions s’appliquent. Un désaccord ? Ouvre un ticket plutôt que d’en débattre en public.' },
        { titre: '⚖️ En cas d’écart', contenu: 'Avertissement, puis mute, puis exclusion. Les cas graves passent directement au bannissement.' },
      ],
